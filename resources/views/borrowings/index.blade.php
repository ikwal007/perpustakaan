                    ...
                    <tr>
                      ...
                      <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                        @if ($borrowing->status == 'borrowed')
                          <span class="p-1.5 text-xs font-medium uppercase tracking-wider text-yellow-800 bg-yellow-200 rounded-lg bg-opacity-60">{{ $borrowing->status }}</span>
                        @else
                      ...
                      <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                        <a href="{{ url('/borrowings/' . $borrowing->id . '/edit') }}" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 no-underline">Edit</a>
            ...
            <div class="grid grid-cols-1 xl:grid-col-2 gap-4 lg:hidden">
              ...
              <div class="bg-white space-y-3 p-4 rounded-lg shadow">
                <div class="flex flex-col items-center space-x-2 text-sm">
                  ...
                  <div class="my-4"><span class="p-1.5 text-xs font-medium uppercase tracking-wider text-yellow-800 bg-yellow-200 rounded-lg bg-opacity-60">{{ $borrowing->status }}</span></div>
                </div>
