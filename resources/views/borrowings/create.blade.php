                  ...
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      {{-- <input
                          ...
                          name="students_id" 
                          id="students_id" 
                          autocomplete="given-students_id" 
                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full h-10 px-2 shadow-md sm:text-sm border-gray-300 rounded-md" 
