              ...
              <tbody class="divide-y divide-gray-200">
                @foreach ($categories as $category)    
                  <tr>
                    ...
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                      <a href="{{ url('/categories/' . $category->id . '/edit') }}" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 no-underline">Edit</a>
